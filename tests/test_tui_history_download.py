...
from bat.simulation import KLINE_HEADERS, write_history_metadata
...
class TuiHistoryDownloadTest(unittest.IsolatedAsyncioTestCase):
    ...
    async def test_existing_history_with_gap_is_backed_up_before_redownload(self):
        observed = {"start": None}
